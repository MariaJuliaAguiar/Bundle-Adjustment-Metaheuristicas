...
fob_iteration_PSO = load('C:\Users\julia\Pictures\geradorartesspace\scan3\convergencia_PSO.txt');
%% Melhores fitness
...
bestFit_PSO = load('C:\Users\julia\Pictures\geradorartesspace\scan3\best_fit_PSO.txt');
...
axis ([-20 length(fob_iteration_GWO)+100 min([Best_score_GWO Best_score_BAT Best_score_AOA Best_score_SSA Best_score_PSO]) fob_iteration_GWO(1)+100])
grid on
box on
...
xlabel('Iteration');
ylabel('Best score obtained so far');
axis ([-20 length(fob_iteration_BAT)+100 min([Best_score_GWO Best_score_BAT Best_score_AOA Best_score_SSA Best_score_PSO]) fob_iteration_BAT(1)+100])
grid on
box on
% 
subplot(1,5,3);
...
xlabel('Iteration');
ylabel('Best score obtained so far');
axis ([-20 length(fob_iteration_AOA)+100 min([Best_score_GWO Best_score_BAT Best_score_AOA Best_score_SSA Best_score_PSO]) fob_iteration_AOA(1)+100])
grid on
box on
...
xlabel('Iteration');
ylabel('Best score obtained so far');
axis ([-20 length(fob_iteration_SSA)+100 min([Best_score_GWO Best_score_BAT Best_score_AOA Best_score_SSA Best_score_PSO]) fob_iteration_SSA(1)+100])
grid on
box on

subplot(1,5,5);

semilogy(1:t,fob_iteration_PSO)
title(['PSO: ', num2str(Best_score_PSO)])
xlabel('Iteration');
ylabel('Best score obtained so far');
axis ([-20 length(fob_iteration_PSO)+100 min([Best_score_GWO Best_score_BAT Best_score_AOA Best_score_SSA Best_score_PSO]) fob_iteration_PSO(1)+100])
grid on
box on
%% box plot
